...
function(teensy_set_dynamic_properties)
    ...
    if (TEENSY_VERSION EQUAL 30)
        set(CPU_DEFINE __MK20DX128__ PARENT_SCOPE)
        set(LINKER_FILE ${COREPATH}mk20dx128.ld PARENT_SCOPE)
    elseif(TEENSY_VERSION EQUAL 40)
        set(CPU_DEFINE __IMXRT1062__ PARENT_SCOPE)
        set(LINKER_FILE ${COREPATH}imxrt1062.ld PARENT_SCOPE)
        set(build_flags_ld "-Wl,--gc-sections,--relax " PARENT_SCOPE)
        set(build_core teensy4 PARENT_SCOPE)
        set(build_mcu imxrt1062 PARENT_SCOPE)
        set(build_warn_data_percentage 99 PARENT_SCOPE)
        set(build_flags_common "-g -Wall -ffunction-sections -fdata-sections" PARENT_SCOPE)
        set(build_flags_dep "-MMD" PARENT_SCOPE)
        set(build_flags_optimize "-Os" PARENT_SCOPE)
        set(build_flags_cpu "-mthumb -mcpu=cortex-m7 -mfloat-abi=hard -mfpu=fpv5-d16" PARENT_SCOPE)
        set(build_flags_defs "-D__IMXRT1062__ -DTEENSYDUINO=153 " PARENT_SCOPE)
        set(build_flags_cpp "-std=gnu++14 -fno-exceptions -fpermissive -fno-rtti -fno-threadsafe-statics -felide-constructors -Wno-error=narrowing" PARENT_SCOPE)
        set(build_flags_c "" PARENT_SCOPE)
        set(build_flags_S "-x assembler-with-cpp" PARENT_SCOPE)
        set(build_flags_libs "-larm_cortexM7lfsp_math -lm -lstdc++" PARENT_SCOPE)
...
function(import_teensy_cores)
    message(STATUS "import_teensy_cores(${CPP_COMPILE_FLAGS})")
