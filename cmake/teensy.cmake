...
function(teensy_add_executable TARGET)
    ...
    foreach(arg IN LISTS ARGN)
        ...
        set(TEENSY_LIB_INO_SOURCES ${TEENSY_LIB_INO_SOURCES} ${INO_SOURCE}) 
    endforeach()
    ...
    endforeach(SOURCE_CPP ${TEENSY_LIB_CPP_SOURCES})
    ...
    foreach(SOURCE_INO ${TEENSY_LIB_INO_SOURCES})
    ...
    endforeach(SOURCE_INO ${TEENSY_LIB_INO_SOURCES})
